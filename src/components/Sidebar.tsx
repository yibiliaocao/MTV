...
const Sidebar = ({ onToggle, activePath = '/' }: SidebarProps) => {
  ...
  useEffect(() => {
    ...
    if (runtimeConfig?.CUSTOM_PARENT_CATEGORY?.length > 0) {
      ...
      setMenuItems((prevItems) => [...prevItems, ...customMenu]);
    }
  }, []);
          ...
          <div className='flex h-full flex-col'>
            ...
            <nav className='px-2 mt-4 space-y-1'>
              <Link
                ...
                onClick={() => setActive('/')}
                data-active={active === '/'}
                className='group flex items-center rounded-lg px-2 py-2 pl-4 text-gray-700 hover:bg-gray-100/30 hover:text-green-600 font-medium min-h-[40px]'
              >
                ...
                {menuItems.map((item) => {
                  ...
                  return (
                    <Link
                      ...
                      className='group flex items-center rounded-lg px-2 py-2 pl-4 text-sm text-gray-700 hover:bg-gray-100/30 hover:text-green-600 min-h-[40px]'
                    >
                      <div className='w-4 h-4 flex items-center justify-center'>
                        <Icon className='h-4 w-4 text-gray-500 group-hover:text-green-600' />
                      </div>
